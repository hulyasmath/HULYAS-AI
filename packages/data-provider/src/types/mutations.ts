...
export type CreateStripeCheckoutSessionOptions = MutationOptions<
  CreateStripeCheckoutSessionResponse,
  CreateStripeCheckoutSessionRequest
>;

export type CreateStripeCustomerPortalResponse = {
  url: string;
};

export type CreateStripeCustomerPortalOptions = MutationOptions<
  CreateStripeCustomerPortalResponse,
  void
>;

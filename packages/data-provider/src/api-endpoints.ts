...
export const updateUserPlan = () => `${BASE_URL}/api/user/plan`;
...
export const adminPlans = () => `${adminRoot}/plans`;
export const adminPlan = (planId: string) => `${adminRoot}/plans/${planId}`;
export const adminUserUsage = (userId: string) => `${adminRoot}/users/${userId}/usage`;
export const adminUserPlan = (userId: string) => `${adminRoot}/users/${userId}/plan`;

// Public plans endpoint (for registration)
export const publicPlans = () => `${BASE_URL}/api/plans/public`;

// Stripe endpoints
export const stripeCreateCheckoutSession = () => `${BASE_URL}/api/stripe/create-checkout-session`;
export const stripeCustomerPortal = () => `${BASE_URL}/api/stripe/customer-portal`;

// MCP API Key endpoints
export const mcpApiKeyEndpoints = {
  generate: () => `${BASE_URL}/api/mcp/apikey/generate`,
  get: () => `${BASE_URL}/api/mcp/apikey`,
  revoke: () => `${BASE_URL}/api/mcp/apikey/revoke`,
};

// Admin Settings endpoints
export const adminSettingsEndpoints = {
  apiConfig: () => `${adminRoot}/settings/api-config`,
  updateApiConfig: () => `${adminRoot}/settings/api-config`,

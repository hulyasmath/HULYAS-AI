...
export const alternateName: Record<string, string> = {
  ...
  [EModelEndpoint.local]: 'Local LLM',
...
export const EndpointURLs = {
  ...
  [EModelEndpoint.local]: 'local://llm', // Not used, intercepted in useSSE
} as const;
...
export enum SettingsTabValues {
  ...
  ACCOUNT = 'account',
  /**
   * Tab for Plans Management (Admin only)
   */
  PLANS = 'plans',
  /**
   * Chat input commands
  ...
  /**
   * Tab for MCP API Key Management (Paid plans only)
   */
  MCP_API_KEY = 'mcp-api-key',
  /**
   * Tab for Subscription/Plan Upgrade
   */
  SUBSCRIPTION = 'subscription',
  /**
   * Tab for Admin Settings (API Management, etc.)
   */
  ADMIN_SETTINGS = 'admin-settings',
  /**
   * Tab for Stripe Payment Settings
   */

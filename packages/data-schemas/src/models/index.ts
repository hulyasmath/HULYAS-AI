...
import { createTransparencyModel } from './transparency';
import { createZeqOperatorModel } from './zeqOperator';
import { createMCPApiKeyModel } from './mcpApiKey';
...
export function createModels(mongoose: typeof import('mongoose')) {
  return {
    ...
    Transparency: createTransparencyModel(mongoose),
    ZeqOperator: createZeqOperatorModel(mongoose),
    MCPApiKey: createMCPApiKeyModel(mongoose),
  };
}

      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-2xl bg-cyan-600 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-cyan-700 disabled:opacity-80 dark:bg-cyan-600 dark:hover:bg-cyan-700"
          >

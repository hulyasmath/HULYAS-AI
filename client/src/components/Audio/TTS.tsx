  ...
  return (
    <>
      ...
      <audio
        ...
        onError={(error) => {
          // Silently handle audio errors - they're non-critical
          // Audio may fail to load due to network issues, format support, or TTS not configured
          // Only log in development mode to reduce console noise
          if (import.meta.env.MODE === 'development') {
            logger.debug('Audio loading error (non-critical):', error);
          }
        }}
        id={`audio-${messageId}`}
        autoPlay

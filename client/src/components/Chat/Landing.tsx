...
export default function Landing({ centerFormOnLanding }: { centerFormOnLanding: boolean }) {
  ...
  // Show HULYAS icon when there's no conversation or when it's the default DeepSeek model
  const shouldShowHulyas = useMemo(() => {
    if (!conversation || !conversation.endpoint) return true;
    return conversation.endpoint === 'DeepSeek' && conversation.model === 'deepseek-chat';
  }, [conversation]);
